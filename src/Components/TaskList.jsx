...
export default function TaskList({
  ...
  return (
    <div className="custom-container mt-24">
      <div>
        <h2 className="text-center text-4xl  text-amber-400 mt-24 mb-10">
          Tasks
        </h2>
        <div className="flex justify-end gap-10 mb-10">
          <input
            ...
            className="px-4 py-2 text-amber-400 rounded-md text-lg bg-transparent border border-amber-400"
          />
          <select
            name="state"
            id="state"
            ...
            className="px-3 py-2 text-black rounded-md text-lg bg-amber-400"
          >
